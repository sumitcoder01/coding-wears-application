  ...
  return (
    <div className="text-gray-600 body-font">
      {categories.map((item) => (
        <div
          key={item.category}
          className="container text-center py-16 px-5 mx-auto"
        >
          <h2 className="text-2xl mb-5 text-pink-500 font-semibold">
            Top {item.category}s
          </h2>
                      ...
                      <div className="mt-4">
                        ...
                        <div className="my-2">
                          {products[title]["color"].sort().map((color) => (
                            <button
                              key={color}
                              className={`border-2 border-gray-300 mr-1 ${color !== "black"
                                  ? `bg-${color}-600`
                                  : "bg-black"
