      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          <h1 className="title-font sm:text-4xl text-2xl mb-4 font-medium text-gray-900">
            Wear the Code
            <br className="hidden lg:inline-block text-md" />Feel the code
          </h1>
          ...
          <div className="flex justify-center">
            <Link href="/products">
              <span className="inline-flex text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded text-lg">
                Shop Now
              </span>
            </Link>
            <Link href="/about">
